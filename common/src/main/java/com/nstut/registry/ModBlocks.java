...
public class ModBlocks {
    ...
    // Ebony Wood Set
    public static final RegistrySupplier<Block> EBONY_LOG = registerBlock("ebony_log", EbonyLogBlock::new);
    public static final RegistrySupplier<Block> STRIPPED_EBONY_LOG = registerBlock("stripped_ebony_log", StrippedEbonyLogBlock::new);
    public static final RegistrySupplier<Block> EBONY_LEAVES = registerBlock("ebony_leaves", EbonyLeavesBlock::new);
    public static final RegistrySupplier<Block> EBONY_SAPLING = registerBlock("ebony_sapling", EbonySaplingBlock::new);
