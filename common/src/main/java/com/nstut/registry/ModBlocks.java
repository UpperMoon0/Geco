...
public class ModBlocks {
    ...
    public static final RegistrySupplier<Block> EBONY_SIGN = registerBlock("ebony_sign", () -> new StandingSignBlock(EBONY_WOOD_TYPE, BlockBehaviour.Properties.ofFullCopy(EBONY_PLANKS.get()).noOcclusion().strength(1.0f)), new Item.Properties());
    public static final RegistrySupplier<Block> EBONY_WALL_SIGN = registerBlock("ebony_wall_sign", () -> new WallSignBlock(EBONY_WOOD_TYPE, BlockBehaviour.Properties.ofFullCopy(EBONY_PLANKS.get()).noOcclusion().strength(1.0f).dropsLike(EBONY_SIGN.get())), new Item.Properties());
